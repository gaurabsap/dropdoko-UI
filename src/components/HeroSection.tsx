            ...
            >
              ...
              <div className="w-full lg:w-1/2 h-full flex items-center justify-center px-4 sm:px-6 lg:px-10 py-4 lg:py-6">
                <div className="w-full text-center lg:text-left">
                  ...
                  <h1 className="text-xl sm:text-4xl lg:text-[40px] font-extrabold text-white mb-3 leading-tight">
                    {slide.title}
                  </h1>
                  <p className="text-sm sm:text-[10px] md:text-[14px] lg:text-[18px] text-white lg:text-[#333333] mb-5">
                    {slide.description}
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                    <button className="px-3 py-1 sm:px-6 sm:py-2 bg-transparent border border-[#F4EFEA] text-white font-medium rounded-full transition-all duration-300 transform hover:-translate-y-1 text-sm sm:text-base lg:text-[16px]">
                      Add to cart
                    </button>
                  </div>
                </div>
              ...
              <div className="relative w-full sm:w-[400px] lg:w-[500px] h-[200px] sm:h-[350px] lg:h-[400px] flex items-center justify-center">
                ...
                <div className="relative z-10">
                  <Image
                    ...
                    width={700}
                    height={600}
                    className="object-contain max-h-[180px] sm:max-h-[200px] md:max-h-[250px] lg:max-h-[500px]"
                    priority={index === 0}
                  />
                </div>
              </div>
